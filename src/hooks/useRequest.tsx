...
>(props: UseRequestProps<T, B, Q, P>, deps: any[] = []): UseRequestReturn<T, B, Q, P> {
    ...
    const validationDeps = useMemo(() => {
        ...
        return {};
    }, [isHttpMode, isActionMode, props, deps]);
    ...
    const isValid = useMemo(() => {
        ...
        return false;
    }, [props.validator, validationDeps, isHttpMode, isActionMode, deps]);
    ...
    }, [props, isValid, isHttpMode, isActionMode, deps]);
