        ...
        <Container maxWidth="md" sx={{ py: 6 }}>
            ...
            <motion.div
                ...
                <Typography variant="body1" color="text.secondary" component={"p"}>
                    <strong>M2 Drive</strong> Aplikasi ini dikembangkan khusus untuk <strong>MAN 2 Kota Pekanbaru</strong> sebagai
                    solusi penyimpanan dan pengelolaan dokumen digital.
                    Dengan antarmuka yang modern dan mudah digunakan, <strong>M2 Drive</strong> memudahkan guru, staf, dan siswa
